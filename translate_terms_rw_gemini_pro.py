...
def translate_batch_gemini(texts, lang, api_key):
    # Using gemini-1.5-pro for separate, untouched 50 RPD daily quota!
...
def translate_html_gemini(filepath, target_langs, api_key):
    ...
    for lang in target_langs:
        ...
        print(f"\n--- Translating to {lang} via block-level Gemini 1.5 Pro ---")
        sys.stdout.flush()
        ...
        if html_fragments:
            ...
            for i in range(0, len(html_fragments), chunk_size):
                ...
                # 30.5 seconds sleep to perfectly stay under 2 RPM (Requests Per Minute) free limit!
                time.sleep(30.5) 
...
if __name__ == "__main__":
    ...
    print("Translating the final terms.html to Kinyarwanda (rw) via Gemini 1.5 Pro (Flagship)...")
    sys.stdout.flush()
