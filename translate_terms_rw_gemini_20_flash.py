...
def translate_batch_gemini(texts, lang, api_key):
    # Using gemini-2.0-flash for separate, untouched 1,500 RPD daily quota!
...
def translate_html_gemini(filepath, target_langs, api_key):
    ...
    for lang in target_langs:
        ...
        print(f"\n--- Translating to {lang} via block-level Gemini 2.0 Flash ---")
        sys.stdout.flush()
...
if __name__ == "__main__":
    ...
    print("Translating the final terms.html to Kinyarwanda (rw) via Gemini 2.0 Flash...")
    sys.stdout.flush()
