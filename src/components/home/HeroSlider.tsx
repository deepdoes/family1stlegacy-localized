  ...
  const slidesEs = [
    {
      ...
      title: <>Proteja a las personas<br />que más <em>importan.</em></>,
      sub: "La vida puede cambiar en un momento. Las personas que amas merecen un plan que ayude a protegerlas cuando más lo necesitan. Te ayudamos a explorar opciones de cobertura de compañías bien establecidas.",
    ...
    },
    {
      ...
      title: <>Sus años dorados,<br />planificados con <em>cuidado.</em></>,
      sub: "La jubilación debe sentirse tranquila, no incierta. Ya sea que estés comenzando a ahorrar o perfeccionando un plan existente, te ayudamos a construir una estrategia de jubilación adaptada a tu cronograma.",
    ...
    },
    {
      ...
      title: <>Invierta en su<br />brillante <em>futuro.</em></>,
      sub: "Cada niño merece la oportunidad de soñar en grande. Comienza a planificar hoy para que tus hijos puedan seguir cualquier sueño, cualquier escuela o cualquier camino con menos límites financieros.",
    ...
    },
    {
      ...
      title: <>Deje un legado que<br />perdure <em>generaciones.</em></>,
      sub: "Todo aquello por lo que has trabajado cuenta una historia. Te ayudamos a explorar estrategias patrimoniales y de legado que honren tus valores y ayuden a tu familia a estar mejor preparada.",
    ...
    },
    {
      ...
      title: <>Proteja el negocio<br />que ha <em>construido.</em></>,
      sub: "Trabajaste duro para construir tu negocio. Desde cobertura para personas clave hasta estrategias de sucesión, ayudamos a los dueños de negocios a explorar formas de proteger lo que tanto les costó crear.",
    ...
    },
    {
      ...
      title: <>Construya un negocio<br />significativo al <em>servicio.</em></>,
      sub: "¿Buscas una carrera donde tu esfuerzo impacte directamente a las familias de tu comunidad? Empoderamos a personas motivadas para construir carreras en servicios financieros flexibles y con licencia.",
