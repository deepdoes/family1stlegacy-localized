...
"""
    ...
    # Using llama-3.3-70b-versatile for fresh daily token limits and elite translation quality!
    data = {
...
def translate_html_groq(filepath, target_langs, api_key):
    ...
    for lang in target_langs:
        ...
        print(f"\n--- Translating to {lang} via block-level Llama 3.3 70B Engine ---")
        sys.stdout.flush()
...
if __name__ == "__main__":
    ...
    print("Translating the final terms.html to Kinyarwanda (rw) via Groq Llama 3.3 70B Engine...")
    sys.stdout.flush()
